    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <a href="{{ route('login') }}" class="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="font-semibold text-slate-700">Login</h3>
        ...
        <a href="{{ route('register') }}" class="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="font-semibold text-slate-700">Register</h3>
                    <p class="text-sm text-slate-500">Create a new account</p>
                </div>
            </div>
        </a>
        @endguest
        ...
        @auth
        <div class="block p-6 bg-white rounded-lg shadow-md col-span-2">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-slate-500">You are logged in</p>
                    </div>
                </div>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg shadow-md transition-colors">
                        Logout
                    </button>
                </form>
            </div>
