...
<div class="space-y-6">
    ...
    {{-- Quick Links --}}
    <div class="grid grid-cols-2 gap-4">
        <a href="{{ route('age-check') }}" class="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="font-semibold text-slate-700">Age Verification</h3>
                    <p class="text-sm text-slate-500">Verify your age</p>
                </div>
            </div>
        </a>
